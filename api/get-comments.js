// GET /api/get-comments — proxies to Apps Script's getComments().
// (Self-contained — no imports from other files, so there's no nested
// folder to worry about when uploading to GitHub.)
...
module.exports = async function handler(req, res) {
  ...
  try {
    const data = await callAppsScript('getComments', []);
